...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_19487 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_19487(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_19507 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_19507(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_19513 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_19513(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_19516 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_19516(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_19520 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_19520(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_19527 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_19527(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__19470,callback){
var map__19471 = p__19470;
var map__19471__$1 = cljs.core.__destructure_map(map__19471);
var input = map__19471__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19471__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19471__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
