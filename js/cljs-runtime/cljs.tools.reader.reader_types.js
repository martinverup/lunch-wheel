...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_19758 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_19758(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_19759 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_19759(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19760 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19760(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19761 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19761(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19762 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19762(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19763 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19763(reader);
}
});
...
var G__19776 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__19777 = s.append(c);
c = G__19776;
s = G__19777;
continue;
}
