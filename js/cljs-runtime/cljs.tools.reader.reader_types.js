...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_20997 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_20997(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21002 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21002(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21011 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21011(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21018 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21018(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21026 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21026(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21036 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21036(reader);
}
});
...
var G__21145 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__21146 = s.append(c);
c = G__21145;
s = G__21146;
continue;
}
